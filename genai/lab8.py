...
#split the text into chunks and load everything into our Chroma vector database.
...
#define the mechanism to use for the agent and retrieving data. ("qa" = question and answer)
